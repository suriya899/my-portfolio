...
export const skillPhilosophy = {
  ...
  description:
    `I'm currently focused on mastering the React and Node.js ecosystem.
...
export const bmoUnknownCommand = "❓ BMO doesn't understand that command. Type 'help' to see available commands!"
