// Contact.jsx
// Contact Section — Prismo + Form + Toast
...
export default function Contact() {
  ...
  return (
    <section
      ...
      //ลบ bg ออก เตรียม glassmorphism
    ...
    >
      ...
      >
        ...
        <motion.h2
          ...
          whileInView="visible"
          viewport={{ once: true }}
          className="text-7xl font-bold text-center text-jake mb-4 tracking-widest"
          style={{
        ...
        <motion.p
          ...
          whileInView="visible"
          viewport={{ once: true }}
          className="text-2xl text-center text-gray-500 dark:text-gray-400 mb-14"
          style={{
          ...
          >
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                className="
                                    px-4 py-3 rounded-xl border-2 border-gray-200
        ...
        <motion.p
          ...
          whileInView="visible"
          viewport={{ once: true }}
          className="text-center text-gray-400 text-lg mt-16"
        >
