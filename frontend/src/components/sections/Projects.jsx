    ...
    >
      ...
      >
        ...
        >
          ...
          {projectPhilosophy.paragraphs.map((para, index) => (
            <motion.p
              ...
              className="text-2xl leading-relaxed text-gray-600 dark:text-gray-300 tracking-wider"
              style={{
        ...
        <motion.p
          ...
          className="mt-6 text-xl font-mono text-gray-400 dark:text-gray-500"
        >
